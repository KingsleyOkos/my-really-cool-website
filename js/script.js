...
// ===== jQuery Ready: Initialize Slick Carousel =====
  $(document).ready(function () {
    ...
    let watchlist = [
        ...
        { title: "Avatar the Last Airbender", rating: null, watched: false },
        ...
        { title: "One Punch Man", rating: null, watched: false },
        { title: "Mamma Mia", rating: null, watched: false },
        { title: "Mob Psycho 100", rating: null, watched: false},
        ...
        { title: "Adolescence", rating: 96, watched: true },
        { title: "Everything Everywhere All at Once", rating: 95, watched: true },
        { title: "Cyberpunk: Edgerunners", rating: 94, watched: true },
        { title: "Superman (2025)", rating: 93, watched: true},
        { title: "Arcane (S1)", rating: 92, watched: true },
        { title: "Black Mirror (S1-6)", rating: 91, watched: true},
        { title: "To Be Hero X", rating: 90, watched: true},
        { title: "Hamilton", rating: 89, watched: true },
        { title: "Invincible (S1)", rating: 88, watched: true },
        { title: "Joker (2019)", rating: 87, watched: true },
        { title: "Sinners", rating: 86, watched: true },
        { title: "How to Train your Dragon (2025)", rating: 85, watched: true },
        { title: "Puss in Boots: The Last Wish", rating: 84, watched: true },
        { title: "Love Death + Robots (S1-3)", rating: 83, watched: true},
        { title: "The Room", rating: 82, watched: true },
        { title: "Arcane (S2)", rating: 81, watched: true },
        { title: "Get Out", rating: 80, watched: true },
        { title: "The Batman", rating: 79, watched: true },
        { title: "Invincible (S3)", rating: 78, watched: true },
        { title: "Scott Pilgrim Takes Off", rating: 77, watched: true },
        { title: "The Incredibles", rating: 76, watched: true },
        { title: "Saltburn", rating: 75, watched: true},
        { title: "Fantastic Four: First Steps", rating: 74, watched: true},
        { title: "All Quiet on the Western Front", rating: 73, watched: true },
        { title: "Squid Game (S1)", rating: 72, watched: true },
        { title: "How to Train Your Dragon", rating: 71, watched: true },
        { title: "Cunk on Earth", rating: 71, watched: true },
        { title: "Invincible (S2)", rating: 70, watched: true },
        { title: "Coraline", rating: 69, watched: true },
        { title: "The Nightmare Before Christmas", rating: 68, watched: true },
        { title: "TMNT: Mutant Mayhem", rating: 67, watched: true},
        { title: "Avengers: Infinity War", rating: 66, watched: true },
        { title: "Mulan (1998)", rating: 65, watched: true },
        { title: "Avengers: Endgame", rating: 64, watched: true },
        { title: "End of the F***ing World", rating: 63, watched: true },
        { title: "Wallace & Gromit: Vengeance Most Fowl", rating: 62, watched: true},
        { title: "Better Man", rating: 60, watched: true },
        { title: "Weapons", rating: 59, watched: true },
        { title: "Pulp Fiction", rating: 58, watched: true },
        { title: "Lilo & Stitch (2025)", rating: 57, watched: true},
        { title: "Violet Evergarden", rating: 56, watched: true },
        { title: "The Boy and The Heron", rating: 55, watched: true },
        { title: "Sex Education", rating: 50, watched: true },
        { title: "Love Death + Robots (S4)", rating: 45, watched: true },
